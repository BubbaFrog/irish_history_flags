Irish History Flags Mod v1.0
By BubbaFrog, adapted from the prideflags mod by Leslie E. Krause


  /giveme irsh_history_flags:mast_lower
  /giveme irsh_history_flags:mast_upper

By default, The current "Ireland" flag will appear when the upper mast is placed 
